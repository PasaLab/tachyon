 ...
 */
@NotThreadSafe
public abstract class LocalAbstractEvictor extends AbstractBlockStoreEventListener implements
    Evictor {
   ...
   */
  public LocalAbstractEvictor(BlockMetadataManagerView view, Allocator allocator) {
  ...
  @Override
  //TODO(call it serval times by splitting the bytesToBeAvailable)
