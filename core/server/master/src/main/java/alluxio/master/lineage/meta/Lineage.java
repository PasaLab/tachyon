...
public final class Lineage implements JournalEntryRepresentable {
  ...
  public Lineage(long id, List<Long> inputFiles, List<Long> outputFiles, Job job,
      long creationTimeMs) {
    mInputFiles = Preconditions.checkNotNull(inputFiles, "inputFiles is null");
    mOutputFiles = Preconditions.checkNotNull(outputFiles,"wrong outputFiles is null");
    mJob = Preconditions.checkNotNull(job,"job is null");
    mId = id;
