            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.owners = new java.util.ArrayList<java.lang.String>(_list38.size);
                java.lang.String _elem39;
                for (int _i40 = 0; _i40 < _list38.size; ++_i40)
                {
                  _elem39 = iprot.readString();
                  struct.owners.add(_elem39);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.blockIds != null) {
        oprot.writeFieldBegin(BLOCK_IDS_FIELD_DESC);
        {
          ...
          for (long _iter41 : struct.blockIds)
          {
      ...
      if (struct.fileBlockInfos != null) {
        oprot.writeFieldBegin(FILE_BLOCK_INFOS_FIELD_DESC);
        {
          ...
          for (FileBlockInfo _iter42 : struct.fileBlockInfos)
          {
            _iter42.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.owners != null) {
        oprot.writeFieldBegin(OWNERS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter43 : struct.owners)
          {
      ...
      if (struct.isSetFileBlockInfos()) {
        {
          ...
          for (FileBlockInfo _iter45 : struct.fileBlockInfos)
          {
            _iter45.write(oprot);
          }
        }
      ...
      if (struct.isSetOwners()) {
        {
          ...
          for (java.lang.String _iter46 : struct.owners)
          {
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.blockIds = new java.util.ArrayList<java.lang.Long>(_list47.size);
          long _elem48;
      ...
      if (incoming.get(21)) {
        {
          ...
          struct.fileBlockInfos = new java.util.ArrayList<FileBlockInfo>(_list50.size);
          FileBlockInfo _elem51;
          for (int _i52 = 0; _i52 < _list50.size; ++_i52)
          {
            _elem51 = new FileBlockInfo();
            _elem51.read(iprot);
            struct.fileBlockInfos.add(_elem51);
          }
        }
        struct.setFileBlockInfosIsSet(true);
      }
      ...
      if (incoming.get(26)) {
        {
          ...
          struct.owners = new java.util.ArrayList<java.lang.String>(_list53.size);
          java.lang.String _elem54;
          for (int _i55 = 0; _i55 < _list53.size; ++_i55)
          {
            _elem54 = iprot.readString();
            struct.owners.add(_elem54);
          }
        }
        struct.setOwnersIsSet(true);
      }
