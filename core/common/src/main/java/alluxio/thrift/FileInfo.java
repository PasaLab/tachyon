...
public class FileInfo implements org.apache.thrift.TBase<FileInfo, FileInfo._Fields>, java.io.Serializable, Cloneable, Comparable<FileInfo> {
  ...
  private static final org.apache.thrift.protocol.TField IS_SHARE_FIELD_DESC = new org.apache.thrift.protocol.TField("isShare", org.apache.thrift.protocol.TType.BOOL, (short)27);
  private static final org.apache.thrift.protocol.TField OWNERS_FIELD_DESC = new org.apache.thrift.protocol.TField("owners", org.apache.thrift.protocol.TType.LIST, (short)28);
  ...
  public java.lang.String persistenceState; // required
  public boolean mountPoint; // required
  public java.util.List<FileBlockInfo> fileBlockInfos; // required
  /**
   * 
  ...
  public boolean isShare; // required
  public java.util.List<java.lang.String> owners; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    IS_SHARE((short)27, "isShare"),
    OWNERS((short)28, "owners");
  ...
  private static final int __ISSHARE_ISSET_ID = 16;
  ...
  public FileInfo(FileInfo other) {
    ...
    if (other.isSetOwners()) {
      java.util.List<java.lang.String> __this__owners = new java.util.ArrayList<java.lang.String>(other.owners);
  ...
  public void unsetInAlluxioPercentage() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __INALLUXIOPERCENTAGE_ISSET_ID);
  }
  ...
  public boolean isSetInAlluxioPercentage() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __INALLUXIOPERCENTAGE_ISSET_ID);
  }

  public void setInAlluxioPercentageIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __INALLUXIOPERCENTAGE_ISSET_ID, value);
  }
  ...
  public FileInfo setIsShare(boolean isShare) {
    this.isShare = isShare;
    setIsShareIsSet(true);
    return this;
  }
  ...
  public void unsetIsShare() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __ISSHARE_ISSET_ID);
  }

  /** Returns true if field isShare is set (has been assigned a value) and false otherwise */
  public boolean isSetIsShare() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __ISSHARE_ISSET_ID);
  }

  public void setIsShareIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ISSHARE_ISSET_ID, value);
  }
  ...
  public java.util.Iterator<java.lang.String> getOwnersIterator() {
    return (this.owners == null) ? null : this.owners.iterator();
  }

  public void addToOwners(java.lang.String elem) {
    if (this.owners == null) {
      this.owners = new java.util.ArrayList<java.lang.String>();
    }
  ...
  public FileInfo setOwners(java.util.List<java.lang.String> owners) {
    this.owners = owners;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case IN_ALLUXIO_PERCENTAGE:
      if (value == null) {
        ...
        setInAlluxioPercentage((java.lang.Integer)value);
      }
      break;
    ...
    case IS_SHARE:
      if (value == null) {
        ...
        setIsShare((java.lang.Boolean)value);
      }
      break;
    ...
    case OWNERS:
      if (value == null) {
        ...
        setOwners((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public boolean equals(FileInfo that) {
    ...
    boolean this_present_isShare = true;
    boolean that_present_isShare = true;
    if (this_present_isShare || that_present_isShare) {
      if (!(this_present_isShare && that_present_isShare))
        return false;
      if (this.isShare != that.isShare)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + inAlluxioPercentage;

    hashCode = hashCode * 8191 + ((isShare) ? 131071 : 524287);

    hashCode = hashCode * 8191 + ((isSetOwners()) ? 131071 : 524287);
    if (isSetOwners())
      hashCode = hashCode * 8191 + owners.hashCode();
  ...
  public int compareTo(FileInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetInAlluxioPercentage()).compareTo(other.isSetInAlluxioPercentage());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIsShare()).compareTo(other.isSetIsShare());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsShare()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOwners()).compareTo(other.isSetOwners());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOwners()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.blockIds = new java.util.ArrayList<java.lang.Long>(_list40.size);
                long _elem41;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fileBlockInfos = new java.util.ArrayList<FileBlockInfo>(_list43.size);
                FileBlockInfo _elem44;
                for (int _i45 = 0; _i45 < _list43.size; ++_i45)
                {
                  _elem44 = new FileBlockInfo();
                  _elem44.read(iprot);
                  struct.fileBlockInfos.add(_elem44);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.owners = new java.util.ArrayList<java.lang.String>(_list46.size);
                java.lang.String _elem47;
                for (int _i48 = 0; _i48 < _list46.size; ++_i48)
                {
                  _elem47 = iprot.readString();
                  struct.owners.add(_elem47);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.blockIds != null) {
        oprot.writeFieldBegin(BLOCK_IDS_FIELD_DESC);
        {
          ...
          for (long _iter49 : struct.blockIds)
          {
      ...
      if (struct.fileBlockInfos != null) {
        oprot.writeFieldBegin(FILE_BLOCK_INFOS_FIELD_DESC);
        {
          ...
          for (FileBlockInfo _iter50 : struct.fileBlockInfos)
          {
            _iter50.write(oprot);
          }
          oprot.writeListEnd();
      ...
      oprot.writeBool(struct.isShare);
      oprot.writeFieldEnd();
      if (struct.owners != null) {
        oprot.writeFieldBegin(OWNERS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter51 : struct.owners)
          {
      ...
      if (struct.isSetBlockIds()) {
        {
          ...
          for (long _iter52 : struct.blockIds)
          {
      ...
      if (struct.isSetFileBlockInfos()) {
        {
          ...
          for (FileBlockInfo _iter53 : struct.fileBlockInfos)
          {
            _iter53.write(oprot);
          }
        }
      ...
      if (struct.isSetOwners()) {
        {
          ...
          for (java.lang.String _iter54 : struct.owners)
          {
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.blockIds = new java.util.ArrayList<java.lang.Long>(_list55.size);
          long _elem56;
      ...
      if (incoming.get(21)) {
        {
          ...
          struct.fileBlockInfos = new java.util.ArrayList<FileBlockInfo>(_list58.size);
          FileBlockInfo _elem59;
          for (int _i60 = 0; _i60 < _list58.size; ++_i60)
          {
            _elem59 = new FileBlockInfo();
            _elem59.read(iprot);
            struct.fileBlockInfos.add(_elem59);
          }
        }
        struct.setFileBlockInfosIsSet(true);
      }
      ...
      if (incoming.get(26)) {
        {
          ...
          struct.owners = new java.util.ArrayList<java.lang.String>(_list61.size);
          java.lang.String _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = iprot.readString();
            struct.owners.add(_elem62);
          }
        }
        struct.setOwnersIsSet(true);
      }
