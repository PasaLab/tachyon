...
public class FileSystemMasterWorkerService {
  ...
  public static class fileSystemHeartbeat_args implements org.apache.thrift.TBase<fileSystemHeartbeat_args, fileSystemHeartbeat_args._Fields>, java.io.Serializable, Cloneable, Comparable<fileSystemHeartbeat_args>   {
     ...
     */
    public java.util.List<java.lang.Long> persistedFiles; // required
    /**
     * the method options
     */
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.persistedFiles = new java.util.ArrayList<java.lang.Long>(_list118.size);
                  long _elem119;
                  for (int _i120 = 0; _i120 < _list118.size; ++_i120)
                  {
                    _elem119 = iprot.readI64();
                    struct.persistedFiles.add(_elem119);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, fileSystemHeartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.persistedFiles != null) {
          oprot.writeFieldBegin(PERSISTED_FILES_FIELD_DESC);
          {
            ...
            for (long _iter121 : struct.persistedFiles)
            {
        ...
        if (struct.isSetPersistedFiles()) {
          {
            ...
            for (long _iter122 : struct.persistedFiles)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.persistedFiles = new java.util.ArrayList<java.lang.Long>(_list123.size);
            long _elem124;
            for (int _i125 = 0; _i125 < _list123.size; ++_i125)
            {
              _elem124 = iprot.readI64();
              struct.persistedFiles.add(_elem124);
            }
          }
          struct.setPersistedFilesIsSet(true);
        }
