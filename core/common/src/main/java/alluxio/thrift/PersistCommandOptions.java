...
public class PersistCommandOptions implements org.apache.thrift.TBase<PersistCommandOptions, PersistCommandOptions._Fields>, java.io.Serializable, Cloneable, Comparable<PersistCommandOptions> {
  ...
  public java.util.List<PersistFile> persistFiles; // required
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.persistFiles = new java.util.ArrayList<PersistFile>(_list86.size);
                PersistFile _elem87;
                for (int _i88 = 0; _i88 < _list86.size; ++_i88)
                {
                  _elem87 = new PersistFile();
                  _elem87.read(iprot);
                  struct.persistFiles.add(_elem87);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PersistCommandOptions struct) throws org.apache.thrift.TException {
      ...
      if (struct.persistFiles != null) {
        oprot.writeFieldBegin(PERSIST_FILES_FIELD_DESC);
        {
          ...
          for (PersistFile _iter89 : struct.persistFiles)
          {
            _iter89.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetPersistFiles()) {
        {
          ...
          for (PersistFile _iter90 : struct.persistFiles)
          {
            _iter90.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.persistFiles = new java.util.ArrayList<PersistFile>(_list91.size);
          PersistFile _elem92;
          for (int _i93 = 0; _i93 < _list91.size; ++_i93)
          {
            _elem92 = new PersistFile();
            _elem92.read(iprot);
            struct.persistFiles.add(_elem92);
          }
        }
        struct.setPersistFilesIsSet(true);
      }
