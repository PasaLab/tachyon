...
public class GetWorkerInfoListTResponse implements org.apache.thrift.TBase<GetWorkerInfoListTResponse, GetWorkerInfoListTResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetWorkerInfoListTResponse> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new GetWorkerInfoListTResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new GetWorkerInfoListTResponseTupleSchemeFactory();

  public java.util.List<WorkerInfo> workerInfoList; // required
  ...
  public GetWorkerInfoListTResponse(GetWorkerInfoListTResponse other) {
    if (other.isSetWorkerInfoList()) {
      java.util.List<WorkerInfo> __this__workerInfoList = new java.util.ArrayList<WorkerInfo>(other.workerInfoList.size());
  ...
  public void addToWorkerInfoList(WorkerInfo elem) {
    if (this.workerInfoList == null) {
      this.workerInfoList = new java.util.ArrayList<WorkerInfo>();
    }
    this.workerInfoList.add(elem);
  }

  public java.util.List<WorkerInfo> getWorkerInfoList() {
    return this.workerInfoList;
  }

  public GetWorkerInfoListTResponse setWorkerInfoList(java.util.List<WorkerInfo> workerInfoList) {
    this.workerInfoList = workerInfoList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case WORKER_INFO_LIST:
      if (value == null) {
        ...
        setWorkerInfoList((java.util.List<WorkerInfo>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetWorkerInfoList()) ? 131071 : 524287);
    if (isSetWorkerInfoList())
      hashCode = hashCode * 8191 + workerInfoList.hashCode();
  ...
  public int compareTo(GetWorkerInfoListTResponse other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetWorkerInfoList()).compareTo(other.isSetWorkerInfoList());
    if (lastComparison != 0) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("GetWorkerInfoListTResponse(");
    boolean first = true;
  ...
  private static class GetWorkerInfoListTResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GetWorkerInfoListTResponseStandardScheme getScheme() {
      return new GetWorkerInfoListTResponseStandardScheme();
    }
  }

  private static class GetWorkerInfoListTResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<GetWorkerInfoListTResponse> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.workerInfoList = new java.util.ArrayList<WorkerInfo>(_list0.size);
                WorkerInfo _elem1;
  ...
  private static class GetWorkerInfoListTResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GetWorkerInfoListTResponseTupleScheme getScheme() {
      return new GetWorkerInfoListTResponseTupleScheme();
    }
  }

  private static class GetWorkerInfoListTResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetWorkerInfoListTResponse> {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.workerInfoList = new java.util.ArrayList<WorkerInfo>(_list5.size);
          WorkerInfo _elem6;
