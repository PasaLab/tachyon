...
public class GetMasterInfoTOptions implements org.apache.thrift.TBase<GetMasterInfoTOptions, GetMasterInfoTOptions._Fields>, java.io.Serializable, Cloneable, Comparable<GetMasterInfoTOptions> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new GetMasterInfoTOptionsStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new GetMasterInfoTOptionsTupleSchemeFactory();

  public java.util.Set<MasterInfoField> filter; // required
  ...
  public GetMasterInfoTOptions(
    java.util.Set<MasterInfoField> filter)
  {
    this();
    this.filter = filter;
  }
  ...
  public GetMasterInfoTOptions(GetMasterInfoTOptions other) {
    if (other.isSetFilter()) {
      java.util.Set<MasterInfoField> __this__filter = new java.util.HashSet<MasterInfoField>(other.filter.size());
  ...
  public void addToFilter(MasterInfoField elem) {
    if (this.filter == null) {
      this.filter = new java.util.HashSet<MasterInfoField>();
    }
    this.filter.add(elem);
  }

  public java.util.Set<MasterInfoField> getFilter() {
    return this.filter;
  }

  public GetMasterInfoTOptions setFilter(java.util.Set<MasterInfoField> filter) {
    this.filter = filter;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case FILTER:
      if (value == null) {
        ...
        setFilter((java.util.Set<MasterInfoField>)value);
      }
      break;
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("GetMasterInfoTOptions(");
    boolean first = true;
  ...
  private static class GetMasterInfoTOptionsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GetMasterInfoTOptionsStandardScheme getScheme() {
      return new GetMasterInfoTOptionsStandardScheme();
    }
  }

  private static class GetMasterInfoTOptionsStandardScheme extends org.apache.thrift.scheme.StandardScheme<GetMasterInfoTOptions> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.filter = new java.util.HashSet<MasterInfoField>(2*_set0.size);
  ...
  private static class GetMasterInfoTOptionsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GetMasterInfoTOptionsTupleScheme getScheme() {
      return new GetMasterInfoTOptionsTupleScheme();
    }
  }

  private static class GetMasterInfoTOptionsTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetMasterInfoTOptions> {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.filter = new java.util.HashSet<MasterInfoField>(2*_set5.size);
