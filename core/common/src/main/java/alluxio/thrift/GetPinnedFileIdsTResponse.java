...
public class GetPinnedFileIdsTResponse implements org.apache.thrift.TBase<GetPinnedFileIdsTResponse, GetPinnedFileIdsTResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetPinnedFileIdsTResponse> {
  ...
  public java.util.Set<java.lang.Long> pinnedFileIds; // required
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.pinnedFileIds = new java.util.HashSet<java.lang.Long>(2*_set110.size);
                long _elem111;
                for (int _i112 = 0; _i112 < _set110.size; ++_i112)
                {
                  _elem111 = iprot.readI64();
                  struct.pinnedFileIds.add(_elem111);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPinnedFileIdsTResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.pinnedFileIds != null) {
        oprot.writeFieldBegin(PINNED_FILE_IDS_FIELD_DESC);
        {
          ...
          for (long _iter113 : struct.pinnedFileIds)
          {
  ...
  private static class GetPinnedFileIdsTResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetPinnedFileIdsTResponse> {
      ...
      if (struct.isSetPinnedFileIds()) {
        {
          ...
          for (long _iter114 : struct.pinnedFileIds)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPinnedFileIdsTResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TSet _set115 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.pinnedFileIds = new java.util.HashSet<java.lang.Long>(2*_set115.size);
          long _elem116;
          for (int _i117 = 0; _i117 < _set115.size; ++_i117)
          {
            _elem116 = iprot.readI64();
            struct.pinnedFileIds.add(_elem116);
          }
        }
        struct.setPinnedFileIdsIsSet(true);
      }
