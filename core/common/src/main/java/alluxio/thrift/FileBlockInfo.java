...
public class FileBlockInfo implements org.apache.thrift.TBase<FileBlockInfo, FileBlockInfo._Fields>, java.io.Serializable, Cloneable, Comparable<FileBlockInfo> {
  ...
  public java.util.List<alluxio.thrift.WorkerNetAddress> ufsLocations; // required
  public java.util.List<java.lang.String> ufsStringLocations; // required
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ufsLocations = new java.util.ArrayList<alluxio.thrift.WorkerNetAddress>(_list24.size);
                alluxio.thrift.WorkerNetAddress _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new alluxio.thrift.WorkerNetAddress();
                  _elem25.read(iprot);
                  struct.ufsLocations.add(_elem25);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ufsStringLocations = new java.util.ArrayList<java.lang.String>(_list27.size);
                java.lang.String _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = iprot.readString();
                  struct.ufsStringLocations.add(_elem28);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileBlockInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.ufsLocations != null) {
        oprot.writeFieldBegin(UFS_LOCATIONS_FIELD_DESC);
        {
          ...
          for (alluxio.thrift.WorkerNetAddress _iter30 : struct.ufsLocations)
          {
            _iter30.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.ufsStringLocations != null) {
        oprot.writeFieldBegin(UFS_STRING_LOCATIONS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter31 : struct.ufsStringLocations)
          {
      ...
      if (struct.isSetUfsStringLocations()) {
        {
          ...
          for (java.lang.String _iter33 : struct.ufsStringLocations)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.ufsLocations = new java.util.ArrayList<alluxio.thrift.WorkerNetAddress>(_list34.size);
          alluxio.thrift.WorkerNetAddress _elem35;
          for (int _i36 = 0; _i36 < _list34.size; ++_i36)
          {
            _elem35 = new alluxio.thrift.WorkerNetAddress();
            _elem35.read(iprot);
            struct.ufsLocations.add(_elem35);
          }
        }
        struct.setUfsLocationsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.ufsStringLocations = new java.util.ArrayList<java.lang.String>(_list37.size);
          java.lang.String _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = iprot.readString();
            struct.ufsStringLocations.add(_elem38);
          }
        }
        struct.setUfsStringLocationsIsSet(true);
      }
