...
public enum PropertyKey {
  ...
  WORKER_SCAN_WINDOW_LENGTH(Name.WORKER_SCAN_WINDOW_LENGTH, "18GB"),
  WORKER_SKIP_WINDOW_LENGTH(Name.WORKER_SKIP_WINDOW_LENGTH, "3GB"),
  WORKER_HISTORY_WINDOW_LENGTH(Name.WORKER_HISTORY_WINDOW_LENGTH, "18GB"),
  WORKER_FEATURE_WIDTH(Name.WORKER_FEATURE_WIDTH, 15),
  WORKER_MODEL_PARAMETER_FILE(Name.WORKER_MODEL_PARAMETER_FILE, "parameters.out"),
  ...
  public static final class Name {
    ...
    public static final String WORKER_HISTORY_WINDOW_LENGTH =
        "alluxio.worker.history.window.length";
    public static final String WORKER_FEATURE_WIDTH = "alluxio.worker.feature.width";
    public static final String WORKER_MODEL_PARAMETER_FILE = "alluxio.worker.model.parameter.file";
